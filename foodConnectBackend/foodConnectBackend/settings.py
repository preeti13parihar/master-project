"""
Django settings for foodConnectBackend project.
...
SECRET_KEY = 'django-insecure--*lf4#(%ue@+ajl0*^+^(m2*%gh4sye-eu4g1ch_fd(un+l9ap'
...
ROOT_URLCONF = 'foodConnectBackend.urls'
...
WSGI_APPLICATION = 'foodConnectBackend.wsgi.application'
